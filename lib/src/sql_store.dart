...
//     final sm = MessageStored.fromDataMessage(msg);
//     sm.topicId = topicId;
//     sm.userId = userId;
...
//   Future<MessageStored?> _insertMessage(
//     Topic topic,
//     Drafty data,
//     Map<String, dynamic>? head,
...
//   @override
//   Future<MessageStored?> getMessageById(int dbMessageId) async {
...
//   @override
//   Future<List<MessageStored>?> getQueuedMessages(Topic topic) async {
